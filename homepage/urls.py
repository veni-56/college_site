...
urlpatterns = [
    ...
    # Academic
    path('academic/faculty/', views.faculty_view, name='faculty_all'),  # ✅ should come first
    ...
    path('academic/<slug:slug>/', views.academic_detail, name='academic_detail'),  # ✅ keep this last
